...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1572, 920)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Foo")
    self.driver.find_element(By.NAME, "lname").send_keys("Bar")
    self.driver.find_element(By.NAME, "bizname").send_keys("Baz")
